        ...
        <section className="mb-12">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="p-6 bg-gradient-to-br from-purple-500 to-blue-500 border-4 border-black dark:border-purple-400 shadow-[8px_8px_0_0_#000] dark:shadow-[8px_8px_0_0_#a855f7] relative flex flex-col h-full">
              ...
              <div className="mt-auto pt-4">
                <button className="w-full px-6 py-3 bg-white text-purple-600 font-bold border-3 border-black shadow-[4px_4px_0_0_#000] hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-[2px_2px_0_0_#000] transition-all">
